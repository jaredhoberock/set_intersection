...
inline __device__
  unsigned int blockwise_bounded_count_set_operation_n(InputIterator1 first1, uint16_t n1,
...
inline __device__
  OutputIterator blockwise_bounded_set_operation_n(InputIterator1 first1, uint16_t n1,
                                                   InputIterator2 first2, uint16_t n2,
                                                   OutputIterator result,
                                                   Compare comp,
                                                   SetOperation set_op)
...
inline __device__
  typename thrust::iterator_difference<InputIterator1>::type
    blockwise_count_set_operation(InputIterator1 first1, InputIterator1 last1,
                                  InputIterator2 first2, InputIterator2 last2,
                                  Compare comp,
                                  SetOperation set_op)
{
  ...
  while(remaining_input_size.first + remaining_input_size.second > 0)
  {
    ...
    if(stage_through_smem<value_type>::value)
    {
      ...
      result += blockwise_bounded_count_set_operation_n<block_size,work_per_thread>(s_input.begin(), subpartition_size.first,
    ...
    {
      result += blockwise_bounded_count_set_operation_n<block_size,work_per_thread>(first1, subpartition_size.first,
...
template<uint16_t block_size, uint16_t work_per_thread, typename InputIterator1, typename InputIterator2, typename OutputIterator, typename Compare, typename SetOperation>
inline __device__
OutputIterator blockwise_set_operation(InputIterator1 first1, InputIterator2 last1,
                                       InputIterator2 first2, InputIterator2 last2,
                                       OutputIterator result,
                                       Compare comp,
                                       SetOperation set_op)
{
  ...
  while(remaining_input_size.first + remaining_input_size.second > 0)
  {
    ...
    if(stage_through_smem<value_type>::value)
    {
      ...
      result = blockwise_bounded_set_operation_n<block_size,work_per_thread>(s_input.begin(), subpartition_size.first,
                                                                             s_input_end1,    subpartition_size.second,
                                                                             result,
                                                                             comp,
                                                                             set_op);
    ...
    {
      result = blockwise_bounded_set_operation_n<block_size,work_per_thread>(first1, subpartition_size.first,
                                                                             first2, subpartition_size.second,
                                                                             result,
                                                                             comp,
                                                                             set_op);
                                             ...
                                             SetOperation set_op)
{
      ...
      partition_idx += gridDim.x)
  {
    ...
    difference count = blockwise_count_set_operation<threads_per_block,work_per_thread>(first1 + block_input_begin.first,  first1 + block_input_end.first,
                            ...
                            SetOperation set_op)
{
      ...
      partition_idx += gridDim.x)
  {
    ...
    blockwise_set_operation<threads_per_block,work_per_thread>(first1 + block_input_begin.first,  first1 + block_input_end.first,
                                                               first2 + block_input_begin.second, first2 + block_input_end.second,
                               ...
                               SetOperation set_op)
{
  ...
  set_operation_detail::find_partition_offsets<difference>(input_partition_offsets.size(), maximum_partition_size, first1, last1, first2, last2, input_partition_offsets.begin(), comp);

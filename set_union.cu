...
void test(int size)
{
  ...
  o.erase(my_set_union(a.begin(), a.end(), b.begin(), b.end(), o.begin(), comp), o.end());

  thrust::host_vector<T> h_a = a, h_b = b;
  thrust::host_vector<T> reference(input_size, T(13));
  reference.erase(std::set_union(h_a.begin(), h_a.end(), h_b.begin(), h_b.end(), reference.begin(), comp), reference.end());
  ...
  double msecs = time_invocation_cuda(20, my_set_union<Iterator,Iterator,Iterator,Compare>, a.begin(), a.end(), b.begin(), b.end(), o.begin(), comp);
